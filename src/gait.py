...
class Gait:
    ...
    def draw_straight_line_two_legs(self, 
        ...
        def move_leg0():
            ...
            time.sleep(2)
            self.creepy_pod.legs[0].draw_straight_line(initial_0x, initial_0y + 100, initial_0z, initial_0x, initial_0y + 100, initial_0z + 50, steps=20)
            time.sleep(2)
        ...
        def move_leg2():
            self.creepy_pod.legs[2].draw_straight_line(initial_2x, initial_2y, initial_2z, initial_2x, initial_2y + 100, initial_2z, steps=20)
            time.sleep(2)
            self.creepy_pod.legs[2].draw_straight_line(initial_2x, initial_2y + 100, initial_2z, initial_2x, initial_2y + 100, initial_2z + 50, steps=20)
            time.sleep(2)
            self.creepy_pod.legs[2].draw_straight_line(initial_2x, initial_2y + 100, initial_2z + 50, initial_2x, initial_2y, initial_2z + 50, steps=20)
            time.sleep(2)
            self.creepy_pod.legs[2].draw_straight_line(initial_2x, initial_2y, initial_2z + 50, initial_2x, initial_2y, initial_2z, steps=20)
            time.sleep(2)

        def move_leg3():
            self.creepy_pod.legs[3].draw_straight_line(initial_3x, initial_3y, initial_3z, initial_3x, initial_3y - 100, initial_3z, steps=20)
            time.sleep(2)
            self.creepy_pod.legs[3].draw_straight_line(initial_3x, initial_3y - 100, initial_3z, initial_3x, initial_3y - 100, initial_3z-50, steps=20)
            time.sleep(2)
            self.creepy_pod.legs[3].draw_straight_line(initial_3x, initial_3y - 100, initial_3z-50, initial_3x, initial_3y, initial_3z-50, steps=20)
            time.sleep(2)
        ...
        def move_leg4():
            ...
            time.sleep(2)
            self.creepy_pod.legs[4].draw_straight_line(initial_4x, initial_4y + 100, initial_4z, initial_4x, initial_4y + 100, initial_4z + 50, steps=20)
            time.sleep(2)
            self.creepy_pod.legs[4].draw_straight_line(initial_4x, initial_4y + 100, initial_4z + 50, initial_4x, initial_4y, initial_4z + 50, steps=20)
            time.sleep(2)
            self.creepy_pod.legs[4].draw_straight_line(initial_4x, initial_4y, initial_4z + 50, initial_4x, initial_4y, initial_4z, steps=20)
            time.sleep(2)

        def move_leg5():
            self.creepy_pod.legs[5].draw_straight_line(initial_5x, initial_5y, initial_5z, initial_5x, initial_5y - 100, initial_5z, steps=20)
            time.sleep(2)
            self.creepy_pod.legs[5].draw_straight_line(initial_5x, initial_5y - 100, initial_5z, initial_5x, initial_5y - 100, initial_5z-50, steps=20)
            time.sleep(2)
            self.creepy_pod.legs[5].draw_straight_line(initial_5x, initial_5y - 100, initial_5z-50, initial_5x, initial_5y, initial_5z-50, steps=20)
            time.sleep(2)
