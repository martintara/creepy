...
class Gait:
    ...
    # Simplified gait for rotating left
    ...
    # Simplified gait for rotating right
    ...
    # Forward movement based on inverse kinematics and a global coordinate system
    ...
    # Rotate left movement based on inverse kinematics and a global coordinate system
    ...
    def ripple_rotate_right(self, 
        ...
        def move_leg1():
            ...
            self.creepy_pod.legs[1].draw_straight_line(initial_1x, initial_1y + length, initial_1z + height, initial_1x, initial_1y + length, initial_1z, delay , steps=20) # down
            #step 2
            self.creepy_pod.legs[1].draw_straight_line(initial_1x, initial_1y + length, initial_1z, initial_1x, initial_1y, initial_1z, delay, steps=20) # backward
            time.sleep(2*delay*20)
            #step 3
            time.sleep(3*delay*20)
            #step 4
        ...
        def move_leg2():
            ...
            time.sleep(3*delay*20)
            #step 4
            self.creepy_pod.legs[2].draw_straight_line(initial_2x, initial_2y + length, initial_2z, initial_2x, initial_2y, initial_2z, delay, steps=20) #backward
            time.sleep(2*delay*20)
            #step 5
            self.creepy_pod.legs[2].draw_straight_line(initial_2x, initial_2y, initial_2z, initial_2x, initial_2y, initial_2z + height, delay, steps=20) #up
            self.creepy_pod.legs[2].draw_straight_line(initial_2x, initial_2y, initial_2z + height, initial_2x, initial_2y + length, initial_2z + height, delay, steps=20) #forward
        ...
        def move_leg3():
            ...
            self.creepy_pod.legs[3].draw_straight_line(initial_3x, initial_3y + length, initial_3z + height, initial_3x, initial_3y, initial_3z + height, delay, steps=20) #backward
